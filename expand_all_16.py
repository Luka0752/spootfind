...
# -*- coding: utf-8 -*-
"""
所有16个产品 seoDescription 扩充到 350-400 词（完整版）
"""
...
def main():
    ...
    for prod in data['products']:
        tid = prod['id']
        if tid in products_desc:
            old_words = count_words(prod.get('seoDescription', ''))
            prod['seoDescription'] = products_desc[tid].strip()
    ...
    if updated > 0:
        ...
        print(f"\n✅ 已更新 {updated} 个产品，已保存到 {data_path}")
    else:
        print("\nℹ️  没有产品需要更新")
