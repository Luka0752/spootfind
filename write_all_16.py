...
def main():
    ...
    for prod in data['products']:
        tid = prod['id']
        if tid in final_descs:
            old_words = count_words(prod.get('seoDescription', ''))
            prod['seoDescription'] = final_descs[tid].strip()
